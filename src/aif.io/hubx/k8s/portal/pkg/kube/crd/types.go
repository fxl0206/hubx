	...
	model.Listener.Type: {
		...
		object: &Listener{
			TypeMeta: meta_v1.TypeMeta{
				Kind:       "Function",
				APIVersion: apiVersion(&model.Listener),
			},
		},
...
// CsfService is the generic Kubernetes API object wrapper
...
// GetSpec from a wrapper
func (in *Function) GetSpec() map[string]interface{} {
	return in.Spec
}

// SetSpec for a wrapper
func (in *Function) SetSpec(spec map[string]interface{}) {
	in.Spec = spec
}

// GetObjectMeta from a wrapper
func (in *Function) GetObjectMeta() meta_v1.ObjectMeta {
	return in.ObjectMeta
}

// SetObjectMeta for a wrapper
func (in *Function) SetObjectMeta(metadata meta_v1.ObjectMeta) {
	in.ObjectMeta = metadata
}

// CsfServiceList is the generic Kubernetes API list wrapper
...
// GetItems from a wrapper
func (in *FunctionList) GetItems() []IstioObject {
	out := make([]IstioObject, len(in.Items))
	for i := range in.Items {
		out[i] = &in.Items[i]
	}
